...
<html lang="en">
    ...
    <body class="homepage">
        ...
        <div class="center">
            <div class="grid">
                <div class="row">
                    <h1 class="text-center text-white display-2">Welcome to Match Groups!</h1> <br>
                </div>
                <div class="row">
                    <h1 class="text-center text-white display-4">Mix with the group of your dreams!</h1>
                </div>
                <div class="row">
