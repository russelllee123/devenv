    ...
    <body>
        <nav class="navbar navbar-expand-lg bg-body-secondary">
            <div class="container-fluid">
              <a class="navbar-brand" href="?command=displayStack">MatchGroups</a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="?command=displayStack">Stack </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="?command=displayMatches">Matches </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="?command=displayProfile">Profile </a>
                  </li>
                </ul>
