    ...
    <body>
        <nav class="navbar navbar-expand-lg bg-body-secondary">
            <div class="container-fluid">
              <a class="navbar-brand" href="#">MatchGroups</a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">Stack </a>
                  </li>
                  <li class="nav-item">
          ...
          <div class="invisible-box text-box">
            <h1 class="display-6">Ultimate Frisbee at UVA</h1> <br>
          </div>

          <div class="box contain-image">
            <img src="../images/frisbee-team.jpg" alt="Team of frisbee players">
          </div>
          
          <div class="box text-box">
            <p>The premier ultimate frisbee team at the University of Virginia! Looking for clubs 
                to mix with and try out the sport of Ultimate Frisbee!
            </p>
          </div>

          <div class="box contain-image">
            <img src="../images/frisbee-play.jpg" alt="Team of frisbee players">
          </div>
